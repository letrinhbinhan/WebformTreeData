<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ThemThietBiColumnName.aspx.cs" Inherits="Pages_ThemThietBiColumnName" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="matb" DataSourceID="SqlDataSource1" DefaultMode="Insert" EnableModelValidation="True">
        <EditItemTemplate>
            matb:
