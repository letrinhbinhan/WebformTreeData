...
<% 
    ...
    string loaithietbi, phongban, ngaynhap, thangnhap, namnhap, tenthietbi, nhacungcap, huhong, thoihanbaohanh, nhasanxuat, nuocsanxuat, serial, model, ngaylapdat, thanglapdat, namlapdat, ngaymua, thangmua, nammua, maquanly, mathietbi, thietbicha, vitri;
    ...
    using (System.Data.SqlClient.SqlConnection connection = new System.Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings["QLThietBiConnectionString"].ConnectionString))
        {
            ...
            {       
                ...
                cmd.Parameters.Add("@param15", System.Data.SqlDbType.Int).Value = (Int32.Parse(mathietbi) + 1);
                if(vitri=="NULL") {
                    cmd.Parameters.Add("@param16", System.Data.SqlDbType.Int).Value = DBNull.Value;
                } else {
                    cmd.Parameters.Add("@param16", System.Data.SqlDbType.Int).Value = vitri;
                }
                if(thietbicha=="NULL") {
                    cmd.Parameters.Add("@param17", System.Data.SqlDbType.Int).Value = DBNull.Value;
                } else {
                    cmd.Parameters.Add("@param17", System.Data.SqlDbType.Int).Value = thietbicha;
                }                
                cmd.ExecuteNonQuery();
        ...
        mathietbi = (Int32.Parse(mathietbi) + 1).ToString();
    %>
<%= mathietbi %>
